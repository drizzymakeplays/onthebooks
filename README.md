...
docker-compose up
```
Go to http://localhost:2222/ to connect to the app.
Go to http://localhost:2224/docs to connect to Fastapi Swagger for testing the endpoints and documentation.
...
### Built With
| [<img src="https://www.svgrepo.com/show/331370/docker.svg" alt="docker" width="200" height="200">](https://docs.docker.com/get-docker/) Docker | [<img src="https://github.com/drizzymakeplays/onthebooks/assets/118935604/4461ab69-77ce-4f01-8f97-d2c7278ef30a" width=200px height=200px>](https://fastapi.tiangolo.com/) FastApi | [<img src="https://www.svgrepo.com/show/374167/vite.svg" alt="Vite.js" width="200" height="200">](https://vitejs.dev/) Vite.js | [<img src="https://www.svgrepo.com/show/452091/python.svg" alt="Vite.js" width="200" height="200">](https://www.python.org/) Python | [<img src="https://github.com/drizzymakeplays/onthebooks/assets/118935604/b4a75de8-4afc-4520-b742-eb9a564ae1f6" width=200px height=200px>](https://getbootstrap.com/) BootStrap |
| ----- | --- | ----- | --- | ----- |
